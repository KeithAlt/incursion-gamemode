...
SWEP.Slot = 0
SWEP.PrintName = "Legion Bumper Blade"
SWEP.Author = "Lenny"
SWEP.Spawnable = true
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/lilysblade.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.104, 1.55, 20.556), angle = Angle(0, -90, 185.376), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["knife"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/lilysblade.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-0.245, 1.2, 17.055), angle = Angle(0, -90, 192), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
