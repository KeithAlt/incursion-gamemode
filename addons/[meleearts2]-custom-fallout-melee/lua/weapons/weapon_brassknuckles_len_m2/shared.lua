...
SWEP.WepName="weapon_brassknuckles_len_m2"
...
SWEP.VElements = {
	["brassknuckle"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/knuckles.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.118, 1.026, 0.105), angle = Angle(6.544, -85.57, -90.011), size = Vector(1, 0.893, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["brassknuckles"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/knuckles.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.122, 0.74, 0.09), angle = Angle(-2.77, -84.395, -98.519), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
