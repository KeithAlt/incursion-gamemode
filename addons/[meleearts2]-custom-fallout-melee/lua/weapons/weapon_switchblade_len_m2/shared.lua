...
SWEP.WepName="weapon_switchblade_len_m2"
...
SWEP.DmgMin2 = 50
SWEP.DmgMax2 = 70
SWEP.ThrowModel = "models/mosi/fallout4/props/weapons/melee/switchblade.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
--}
SWEP.VElements = {
	["bowieknife"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/switchblade.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.7, 1, 0), angle = Angle(-2.984, -118.825, -158.325), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["bowieknife"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/switchblade.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.204, 0.646, 1), angle = Angle(0, -82.418, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
