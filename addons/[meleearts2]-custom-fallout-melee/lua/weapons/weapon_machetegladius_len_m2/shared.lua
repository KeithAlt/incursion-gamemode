...
SWEP.WepName="weapon_machetegladius_len_m2"
...
SWEP.DmgMin2 = 50
SWEP.DmgMax2 = 90
SWEP.ThrowModel = "models/weapons/machetegladius/machetegladius.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/weapons/machetegladius/machetegladius.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.3, -0.19, -7), angle = Angle(0, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
