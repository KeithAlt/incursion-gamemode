...
SWEP.Tier=6 -- General rating based on how good/doodoo the weapon is

SWEP.WepName="weapon_hook_len_m2"
...
SWEP.ThrowModel = "models/mosi/fallout4/props/weapons/melee/polehook.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/polehook.mdl", bone = "RW_Weapon", rel = "", pos = Vector(-0.15, -0.5, -11.948), angle = Angle(-1.17, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 2} }
}

SWEP.WElements = {
	["polehook"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/polehook.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.989, 1.182, 11.472), angle = Angle(0.476, -84.662, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 2} }
}
