...
SWEP.WepName="weapon_policebaton_len_m2"
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/baton.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, -0.5, -1.948), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0 }
}
SWEP.WElements = {
	["shishkebab"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/baton.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.275, 1, 5.42), angle = Angle(180, 74.699, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
