...
SWEP.WepName="weapon_laserkatana_len_m2"
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/fallout/weapons/w_laserwakizashi.mdl", bone = "RW_Weapon", rel = "", pos = Vector(-0.5, 0, 3.548), angle = Angle(-90, 90, -180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 2} }
}
SWEP.WElements = {
	["shishkebab"] = { type = "Model", model = "models/fallout/weapons/w_laserwakizashi.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.275, 1, 1), angle = Angle(90, -74.699, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
