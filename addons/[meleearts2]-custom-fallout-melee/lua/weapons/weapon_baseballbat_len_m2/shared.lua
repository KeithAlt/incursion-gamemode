...
SWEP.WepName="weapon_baseballbat_len_m2"
...
SWEP.ThrowModel = "models/mosi/fallout4/props/weapons/melee/baseballbat.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/baseballbat.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, 0.3, -5), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0 }
}
SWEP.WElements = {
	["shishkebab"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/baseballbat.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.275, 1, 4), angle = Angle(180, 74.699, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
