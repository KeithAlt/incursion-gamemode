...
SWEP.Slot = 0
SWEP.PrintName = "Oh Baby! Melee"
SWEP.Author = "Lenny"
SWEP.Spawnable = true
SWEP.AutoSwitchFrom = false
SWEP.Weight = 5
SWEP.Category = "Fallout SWEPs - Melee"
SWEP.SlotPos = 1
...
SWEP.WepName="meleearts_bludgeon_ohbaby_len"
...
SWEP.VElements = {
	["ohbaby"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/supersledgeunique.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.519, -3, -11.948), angle = Angle(-1.17, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 2} },
}
SWEP.WElements = {
	["ohbaby"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/supersledgeunique.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.989, 1.182, 11.472), angle = Angle(0.476, -84.662, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 2} }
}
