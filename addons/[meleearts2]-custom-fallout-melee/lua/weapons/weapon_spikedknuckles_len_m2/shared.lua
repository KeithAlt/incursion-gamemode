...
SWEP.Slot = 0
SWEP.PrintName = "Spiked Brass Knuckles"
SWEP.Author = "Lenny"
SWEP.Spawnable = true
...
SWEP.WepName="weapon_spikedknuckles_len_m2"
...
SWEP.ThrowModel = "models/mosi/fallout4/props/weapons/melee/knuckles.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
SWEP.ThrowForce = 500
...
SWEP.VElements = {
	["spiked"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/spikedknuckles.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.266, 1.046, 0), angle = Angle(0, -74.057, 0), size = Vector(1.019, 1.019, 1.019), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["spikedknuckle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/spikedknuckles.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.062, 0.319, 0), angle = Angle(0, -84.697, 0), size = Vector(1.12, 1.12, 1.12), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}