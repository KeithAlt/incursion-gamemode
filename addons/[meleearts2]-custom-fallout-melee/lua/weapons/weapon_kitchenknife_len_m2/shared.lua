...
SWEP.WepName="weapon_kitchenknife_len_m2"
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/weapons/kitchenknife/kitchenknife.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.3, -0.19, -1.5), angle = Angle(0, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/weapons/kitchenknife/kitchenknife.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.48, 1.229, 0.618), angle = Angle(180, -90.003, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
