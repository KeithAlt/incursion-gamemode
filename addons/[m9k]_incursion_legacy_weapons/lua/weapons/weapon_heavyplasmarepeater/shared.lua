...
SWEP.ViewModel = "models/weapons/heavyplasmarepeater/c_heavyplasmarepeater_len.mdl"
...
SWEP.Primary.Sound 		= Sound("heavyplasma/fire.ogg")
...
SWEP.IronSightsPos = Vector(-3.981, -1.083, 0.1)
...
function SWEP:Reload()
	...
	self:EmitSound(Sound("heavyplasma/reload.ogg")) 
