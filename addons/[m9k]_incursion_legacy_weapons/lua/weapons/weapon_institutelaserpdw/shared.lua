...
SWEP.VElements = {
	...
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Energy Weapons/laserrifleunique.mdl", bone = "v_weapon.Right_Arm", rel = "", pos = Vector(6.739, 1.508, 0.442), angle = Angle(152, -90.296, 1.475), size = Vector(1.001, 1.001, 1.001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }

}

SWEP.WElements = {

	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Energy Weapons/laserrifleunique.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-0.556, 1.115, 1.985), angle = Angle(180, -90.001, 6.765), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
