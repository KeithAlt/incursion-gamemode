...
SWEP.ViewModel = "models/weapons/judicator/c_judicator_len.mdl"
...
SWEP.Primary.Sound 		= Sound("judicator/shoot.wav")
...
SWEP.IronSightsPos = Vector(-6.04, 0, 2.4)
...
function SWEP:Reload()
	...
	if ( self.Weapon:Clip1() < self.Primary.ClipSize ) and self.Owner:GetAmmoCount(self.Primary.Ammo) > 0 then
		...
		self.Weapon:SetNextPrimaryFire(CurTime() + 1.58)
