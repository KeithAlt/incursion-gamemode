...
SWEP.PrintName				= "Jumelle d'artillerie Axis"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Sound			= Sound("weapons/radiooperator/artillerybegin4axis.mp3")		-- script that calls the primary fire sound
