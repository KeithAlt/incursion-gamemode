...
SWEP.UseHands = true
SWEP.ViewModel = "models/teslarcw/c_teslarcw_len.mdl"
SWEP.WorldModel = "models/weapons/w_357.mdl"
SWEP.ShowWorldModel = false

SWEP.Primary.Sound 			= Sound("weapons/riflealien/wpn_alienrifle_fire.wav")
SWEP.Primary.ReloadSound 	= Sound("weapons/laser_rcw/wpn_laserrcw_reload.wav")
...
SWEP.IronSightsPos = Vector(-7.481, 0, 3.079)
