...
SWEP.ViewModel = "models/weapons/mrgatling/c_mrgatling_len.mdl"
SWEP.WorldModel = "models/weapons/w_pistol.mdl"
SWEP.ShowViewModel = true
SWEP.ShowWorldModel = false

SWEP.WElements = {
	["mrgatling"] = { type = "Model", model = "models/weapons/mrgatling/c_mrgatling_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(7.333, 7.735, -3.635), angle = Angle(-3.241, 0, 180), size = Vector(1.205, 1.205, 1.205), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.Contact = "";
SWEP.Author = "Lenny & Karltroid51";
SWEP.Spawnable = true;
SWEP.SlotPos = 0;
SWEP.AutoSwitchFrom = false;
SWEP.DrawAmmo = true;
SWEP.PrintName = "Mr Gatling";
...
SWEP.Primary.Sound = Sound("mrgatling/shoot.mp3")
