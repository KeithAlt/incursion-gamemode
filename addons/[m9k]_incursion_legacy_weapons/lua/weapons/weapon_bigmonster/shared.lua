...
function SWEP:Precache()
    ...
    util.PrecacheSound("monster/damage1.wav")
    util.PrecacheSound("monster/damage2.wav")
    util.PrecacheSound("monster/attack1.wav")
    util.PrecacheSound("monster/attack2.wav")
    util.PrecacheSound("monster/roar1.wav")
    util.PrecacheSound("monster/roar2.wav")
    util.PrecacheSound("monster/roar3.wav")
    util.PrecacheSound("monster/roar4.wav")
    util.PrecacheSound("monster/roar5.wav")
end
...
function SWEP:PrimaryAttack()
    ...
    self.Owner:EmitSound("monster/damage"..math.random(1, 2)..".wav") 
...
function SWEP:SecondaryAttack()
    ...
    if SERVER and not CLIENT then
        self.Owner:EmitSound("monster/attack"..math.random(1, 2)..".wav")
    end
...
function SWEP:Reload()
    ...
    if SERVER and not CLIENT then
        self.Owner:EmitSound("monster/roar"..math.random(1, 5)..".wav")
    end
    self.NextMoan = CurTime() + 2.5 
end