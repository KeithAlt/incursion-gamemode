...
SWEP.WElements = {
	["patriot"] = { type = "Model", model = "models/weapons/1customorder/thepatriot/c_patriot_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-6.52, 5.936, -6.818), angle = Angle(-3.78, 0, 180), size = Vector(0.813, 0.813, 0.813), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/thepatriot/c_patriot_len.mdl"
SWEP.WorldModel = "models/weapons/w_smg1.mdl"
SWEP.ShowWorldModel = false

SWEP.Primary.Sound 			= Sound("patriot/fire.ogg")
SWEP.Primary.ReloadSound 	= Sound("patriot/reload.ogg")
...
SWEP.IronSightsPos = Vector(-6.908, -4.825, 0.996)
