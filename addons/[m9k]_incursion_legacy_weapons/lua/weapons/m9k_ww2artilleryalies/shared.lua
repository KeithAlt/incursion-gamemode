...
SWEP.PrintName				= "Jumelle d'artillerie Alies"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Sound			= Sound("weapons/radiooperator/artillerybegin3alies.mp3")		-- script that calls the primary fire sound
...
function SWEP:PrimaryAttack()
	...
	if !self.Owner:KeyDown(IN_SPEED) and !self.Owner:KeyDown(IN_RELOAD) then
		...
		elseif mark.Entity:IsPlayer() or mark.Entity:IsNPC() then
			...
			if skycheck2.HitSky then //someones gonna be in big trouble
