...
SWEP.PrintName			= "Revo Sniper"					// 'Nice' Weapon name (Shown on HUD)
...
SWEP.ViewModel = "models/weapons/revosniper/c_revosniper_len.mdl"
...
SWEP.Primary.Sound 				= Sound("RevoSniper/shoot.ogg")
...
function SWEP:Reload()
	...
	-- When the current clip < full clip and the rest of your ammo > 0, then
		...
		self.Owner:EmitSound(self.Weapon.Primary.ReloadSound)
