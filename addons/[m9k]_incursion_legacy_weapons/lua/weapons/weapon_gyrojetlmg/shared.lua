...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/gyrojethmg/c_gyrojet_len.mdl"
SWEP.WorldModel = "models/weapons/w_smg1.mdl"
SWEP.ShowWorldModel = false

SWEP.Primary.Sound 			= Sound("weapons/gyrojet/shoot.mp3")
...
SWEP.MuzzleAttachment		= "3" -- Should be "1" for CSS models or "muzzle" for hl2 models
...
SWEP.IronSightsPos = Vector(-8.04, -4.398, 1.919)
