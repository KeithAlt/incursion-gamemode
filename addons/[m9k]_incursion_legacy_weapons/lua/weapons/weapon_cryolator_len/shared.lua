...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/cryolator/c_cryolator_len.mdl"
SWEP.WorldModel = "models/weapons/w_357.mdl"
SWEP.ShowWorldModel = false

SWEP.Primary.Sound 			= Sound("cryolator/fire.wav")
SWEP.Primary.Recoil			= 0
SWEP.Primary.Damage			= 50
SWEP.Primary.NumShots		= 1
SWEP.Primary.Cone			= 0.025
SWEP.Primary.Delay 			= 3.075
...
SWEP.IronSightsPos = Vector(-5.481, 0, 0.239)
...
function SWEP:PrimaryAttack()
	...
	self.Weapon:EmitSound("cryolator/shoot.mp3")
...
function SWEP:FireFrag()
	...
	if SERVER then
	local Frag = ents.Create("proj_sh_cryogrenade_cryolator")
