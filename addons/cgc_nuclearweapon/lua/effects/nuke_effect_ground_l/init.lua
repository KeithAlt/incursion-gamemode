...
tMats.Glow1 = CreateMaterial( "glow1", "UnlitGeneric", {
...
tMats.Glow2 = CreateMaterial( "glow2", "UnlitGeneric", {
...
tMats.Glow3 = CreateMaterial( "glow3", "UnlitGeneric", {
...
function EFFECT:Init( data )
    ...
    if self.CloudHeight < 100 then
        self.CloudHeight = 100
    end
...
function EFFECT:Render( )
    ...
    if self.Size < self.MaxSize then
        ...
        render.DrawQuadEasy( startpos, Vector( 0, 0, 1 ), self.Size, self.Size )
    end
end