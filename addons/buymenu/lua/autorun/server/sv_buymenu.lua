...
function BuyMenu.SQLInit()
	...
	BuyMenu.SQL = BuyMenu.SQL or jlib.MySQL.Create("remote_database_ip_address", jlib.IsDev() and "claymore_buymenu_dev" or "claymore_buymenu", "remote_database_username", "remote_database_password", 3306)
