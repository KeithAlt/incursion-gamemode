...
function EFFECT:GetTracerPos( Position, Ent, Attachment )
	...
	if ( Ent.IsCarriedByLocalPlayer and Ent:IsCarriedByLocalPlayer() && !LocalPlayer():ShouldDrawLocalPlayer() ) then
...
function EFFECT:Init( data )
	...
	if self.WeaponEnt.IsCarriedByLocalPlayer and !self.WeaponEnt:IsCarriedByLocalPlayer() or LocalPlayer():ShouldDrawLocalPlayer() then
