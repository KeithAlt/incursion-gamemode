...
SWEP.Author				= ""
SWEP.Contact				= ""
SWEP.Purpose				= "Throwable spears to stun enemies you're hunting"
SWEP.Instructions				= ""
SWEP.MuzzleAttachment			= "1" 	-- Should be "1" for CSS models or "muzzle" for hl2 models
SWEP.ShellEjectAttachment			= "2" 	-- Should be "2" for CSS models or "1" for hl2 models
SWEP.PrintName				= "Hunter's Spear"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Round 			= ("cgc_thrown_harpoon")	--NAME OF ENTITY GOES HERE
