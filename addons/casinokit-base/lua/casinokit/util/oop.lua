...
function Object:initialize()
	-- Make 'super' member variable available
	self.super = self.class.super
end
...
function CasinoKit.class(nm, superClass, noGlobalEntry)
	...
	-- Try to resolve string into a class
	...
	-- Inherit from Object if from nowhere else
	if not superClass then
		superClass = Object
	end

	assert(not not superClass)
...
local Enum = CasinoKit.class("Enum", Object)
