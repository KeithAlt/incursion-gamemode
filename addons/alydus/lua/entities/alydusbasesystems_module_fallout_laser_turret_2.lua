...
ENT.PrintName = "Module - Laser Turret MKII"
ENT.Author = "Alydus"
ENT.Contact = "Alydus"
ENT.Purpose = ""
ENT.Instructions = ""
...
function ENT:Initialize()
	...
	if SERVER then
		self:SetModel("models/weapons/keitho/turrets/laseradv.mdl")
		self:PhysicsInit(SOLID_VPHYSICS)
		self:SetMoveType(MOVETYPE_VPHYSICS)
		self:SetSolid(SOLID_VPHYSICS)
		self:SetUseType(SIMPLE_USE)
		
		self.dmg = 50 --attack damage
		self.firingDelay = 0.5 --delay between firing
		self.nextFire = 0
