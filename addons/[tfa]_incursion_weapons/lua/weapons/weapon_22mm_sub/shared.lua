...
SWEP.PrintName              = ".22LR SMG"       -- Weapon name (Shown on HUD)
...
SWEP.Primary.ReloadSound = Sound("weapons/9mm/reload.mp3")
...
-- Weapon is a shotgun
--Ammo Related
SWEP.Primary.ClipSize = 61 -- This is the size of a clip
...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/fml/fallout/c_dp28_smol.mdl" --Viewmodel path
