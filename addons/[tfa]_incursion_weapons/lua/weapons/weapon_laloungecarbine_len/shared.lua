...
SWEP.PrintName              = "La Lounge Carbine"       -- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapons/huntingrifle/huntingfire.wav") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/laloungecarbine/c_laloungecarbine_len.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-4.801, 0, 1.72)
...
SWEP.WElements = {
	["leveraction_wm"] = { type = "Model", model = "models/weapons/c_leveraction_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-3.875, 5.177, -4.088), angle = Angle(-14.249, 0, 180), size = Vector(0.885, 0.885, 0.885), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}
