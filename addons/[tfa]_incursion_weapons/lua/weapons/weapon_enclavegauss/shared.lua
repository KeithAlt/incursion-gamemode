...
SWEP.PrintName              = "Enclave Gauss Rifle"       -- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM_Semi = 7000 -- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/gaussrifle/c_gauss_rifle_len.mdl" --Viewmodel path
...
SWEP.ImpactEffect = "ImpactGauss"--Impact Effect
...
SWEP.LMScopePos = Vector(-5.56, -4, 0.12)
...
SWEP.WElements = {
	...
	["gaussrifle"] = { type = "Model", model = "models/weapons/gaussrifle/c_gauss_rifle_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-3.549, 5.745, -7.059), angle = Angle(-6.792, 0, 180), size = Vector(1.046, 1.046, 1.046), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
hook.Add("TFA_Reload", "ViewPuncherREload", function(weap)
	weap.Owner:ViewPunch( Angle( -1, 0, 0 ) )
end)
