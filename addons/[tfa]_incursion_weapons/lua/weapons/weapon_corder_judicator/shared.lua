...
SWEP.PrintName              = "Judicator"       -- Weapon name (Shown on HUD)
...
SWEP.Primary.SpreadIncrement = (980 * 16) --What percentage of the modifier is added on, per shot.  Example val: 1/3.5
...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/judicator/c_judicator_len.mdl" --Viewmodel path
...
SWEP.ProceduralReloadTime = 3.5 --Procedural reload time?
--[[HOLDTYPES]]--
...
--Export from SWEP Creation Kit.  For each item that can/will be toggled, set active=false in its individual table
	SWEP.WElements = {
		["judicator"] = { type = "Model", model = "models/weapons/judicator/c_judicator_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-6.462, 7.219, -6.167), angle = Angle(-4.881, 0, 180), size = Vector(0.908, 0.908, 0.908), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
SWEP.Attachments = {}
