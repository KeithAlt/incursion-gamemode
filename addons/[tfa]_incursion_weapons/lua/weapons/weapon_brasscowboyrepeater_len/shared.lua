...
SWEP.PrintName              = "Brass Cowboy Repeater"       -- Weapon name (Shown on HUD)
...
SWEP.Primary.ReloadSound = Sound("weapons/cowboyrepeater/reload.ogg")
...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/brasscowboyrepeater/c_brasscowboyrepeater_len.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-4.801, -3.467, 2.44)
...
SWEP.WElements = {
	["cowboyrep"] = { type = "Model", model = "models/weapons/brasscowboyrepeater/c_brasscowboyrepeater_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-1.7, 3.881, -5.712), angle = Angle(-8.268, 0, 180), size = Vector(0.669, 0.669, 0.669), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
