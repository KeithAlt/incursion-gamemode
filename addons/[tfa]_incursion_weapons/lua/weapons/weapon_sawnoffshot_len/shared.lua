...
SWEP.PrintName              = "Sawed Off Shotgun"       -- Weapon name (Shown on HUD)
...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/fml/fallout/c_sawnoff.mdl" --Viewmodel path
...
SWEP.WElements = {
	["E"] = { type = "Model", model = "models/weapons/fml/fallout/c_sawnoff.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-4.01, 3.316, -3.758), angle = Angle(-10, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
