...
SWEP.Primary.IronAccuracy = .000005 -- Ironsight accuracy, should be the same for shotguns
...
SWEP.IronSightsPos = Vector(-6.02, -4.222, 1.499)
SWEP.IronSightsAng = Vector(0, 0, 0)
--[[INSPECTION]]--
SWEP.InspectPos = Vector(10,-6,-3)--Vector(0,0,0) --Replace with a vector, in style of ironsights position, to be used for inspection
