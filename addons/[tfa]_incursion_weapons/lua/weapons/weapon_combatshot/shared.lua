...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/combatshotgun/c_combatshot_len.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-7.2, 0, 2.319)
...
SWEP.WElements = {
	["combatshot"] = { type = "Model", model = "models/weapons/combatshotgun/c_combatshot_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-2.431, 6.434, -5.027), angle = Angle(-10.216, 0, 180), size = Vector(0.805, 0.805, 0.805), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
