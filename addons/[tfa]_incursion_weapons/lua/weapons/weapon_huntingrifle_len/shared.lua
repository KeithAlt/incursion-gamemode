...
SWEP.PrintName              = "Hunting Rifle (Scoped)"       -- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapons/huntingrifle/shoot.ogg") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.ReloadSound = Sound("weapons/huntingrifle/reload.ogg")
...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/huntingrifle/c_hunting_rifle_fnv_len.mdl" --Viewmodel path
...
SWEP.Secondary.IronFOV = 11 -- How much you "zoom" in. Less is more!  Don't have this be <= 0.  A good value for ironsights is like 70.
...
SWEP.VElements = {
	["hr_scope"] = { type = "Model", model = "models/weapons/attachments/huntingrifle_scope.mdl", bone = "Hunting", rel = "", pos = Vector(3.832, -4.869, 0), angle = Angle(180, -100.789, -90), size = Vector(0.755, 0.755, 0.755), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = true },
	--["hr_scope_rt"] = { type = "Model", model = "models/rtcircle.mdl", bone = "Hunting", rel = "", pos = Vector(2.881, -0.308, -0.026), angle = Angle(0, -102.308, 180), size = Vector(0.25, 0.25, 0.25), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}, bonemerge = false, active = false },
}


SWEP.LMScopePos = Vector(-4.72, -3.409, 1.039)
...
SWEP.WElements = {
	["45"] = { type = "Model", model = "models/weapons/huntingrifle/c_hunting_rifle_fnv_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-3.056, 5.186, -5.193), angle = Angle(-9.546, 0, 180), size = Vector(0.995, 0.995, 0.995), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["hr_scope_wm"] = { type = "Model", model = "models/weapons/attachments/huntingrifle_scope.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(9.463, 0.671, -6.548), angle = Angle(-10.254, 1.69, 177.179), size = Vector(0.95, 0.95, 0.95), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = true }
}
