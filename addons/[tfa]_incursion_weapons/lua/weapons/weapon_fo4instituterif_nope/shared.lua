...
SWEP.PrintName				= "Institute Courser Rifle"		-- Weapon name (Shown on HUD)
...
--Ammo Related
SWEP.Primary.ClipSize = 99 -- This is the size of a clip
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/w_f04instituterif_fixed.mdl" -- Weapon world model path
...
SWEP.MuzzleFlashEffect = "vj_rifle_smoke_flash_blue" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.
