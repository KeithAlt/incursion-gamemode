...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/LAER/c_LAER_len.mdl" --Viewmodel path
...
--[[SPRINTING]]--
SWEP.IronSightsPos = Vector(-6.2, 0.458, 0.059)
...
SWEP.IronSightsPos = Vector(-6.24, 0, -0.04)
SWEP.IronSightsAng = Vector(0, 0, 0)
...
--Tracer Stuff
SWEP.TracerName         = "effect_fo3_laer"   --Change to a string of your tracer name.  Can be custom. There is a nice example at https://github.com/garrynewman/garrysmod/blob/master/garrysmod/gamemodes/base/entities/effects/tooltracer.lua
...
SWEP.WElements = {
	["laer"] = { type = "Model", model = "models/weapons/laer/c_laer_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-3.745, 6.263, -5.323), angle = Angle(-9.386, 0, 180), size = Vector(0.907, 0.907, 0.907), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
