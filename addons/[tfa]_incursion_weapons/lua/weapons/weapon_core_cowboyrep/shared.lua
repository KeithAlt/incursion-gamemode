...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/cowboyrepeater/c_cowboyrepeater_len.mdl" --Viewmodel path
...
SWEP.WElements = {
	["cowboyrep"] = { type = "Model", model = "models/weapons/cowboyrepeater/c_cowboyrepeater_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-1.974, 3.881, -4.712), angle = Angle(-8.268, 0, 180), size = Vector(0.569, 0.569, 0.569), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
