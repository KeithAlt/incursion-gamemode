...
SWEP.Purpose                = "A good training weapon" --Purpose Tooltip
...
SWEP.PrintName              = "Paintball Gun"       -- Weapon name (Shown on HUD)
...
SWEP.Primary.ReloadSound = Sound("weapons/rifleantimaterial/wpn_antimaterialrifle_reload.wav")
...
--Tracer Stuff
SWEP.TracerName         = "TracerSound"   --Change to a string of your tracer name.  Can be custom. There is a nice example at https://github.com/garrynewman/garrysmod/blob/master/garrysmod/gamemodes/base/entities/effects/tooltracer.lua
SWEP.TracerCount        = 1     --0 disables, otherwise, 1 in X chance
--Impact Effects
SWEP.ImpactEffect = nil--Impact Effect
SWEP.ImpactDecal = "PaintSplatGreen"--Impact Decal
--[[EVENT TABLE]]--
