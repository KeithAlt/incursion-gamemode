...
SWEP.PrintName              = "Gauss Musket"       -- Weapon name (Shown on HUD)
...
SWEP.Primary.DamageBase = 100 -- Fallback number, change this to what it will reset to when shot
...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/customorder3/c_gaussmusket_len.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-4.02, -1.222, -0.33)
...
SWEP.MuzzleFlashEffect = "fo3_muzzle_alienblaster" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.
...
SWEP.WElements = {
	["gaussmusket"] = { type = "Model", model = "models/weapons/customorder3/c_gaussmusket_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-0.641, 3.96, -6.792), angle = Angle(-8.938, 0, 180), size = Vector(0.828, 0.828, 0.828), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
function SWEP:PrimaryAttack()
	...
	elseif self:Clip1() == 2 then
		self.Primary.Damage = self.Primary.Damage + 70
	end

	self:SetClip1(0)
	self:ShootBulletInformation()
	self.Primary.Damage = self.Primary.DamageBase
	self.Primary.IronAccuracy = 0.000005
