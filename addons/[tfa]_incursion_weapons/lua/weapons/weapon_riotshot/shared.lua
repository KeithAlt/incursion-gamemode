...
SWEP.Category               = "Fallout SWEPs - Shotguns" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapons/riotshotgun/shoot.mp3") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.ReloadSound = Sound("weapons/riotshotgun/reload.ogg")
...
SWEP.Primary.SpreadMultiplierMax = 1.75--How far the spread can expand when you shoot. Example val: 2.5
...
--Range Related
SWEP.Primary.Range = 700 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
SWEP.Primary.RangeFalloff = 0.01 -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/riotshotgun_len.mdl" --Viewmodel path
SWEP.ViewModelFOV           = 70        -- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip          = false     -- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands = true --Use gmod c_arms system.

SWEP.VMPos = Vector(-3,0,-1) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
SWEP.IronSightsPos = Vector(-6.30, -2, 1) --Change this, using SWEP Creation Kit preferably
...
--[[ATTACHMENTS]]--
SWEP.VElements = {
	["hr_ironsights"] = { type = "Model", model = "models/weapons/attachments/sniper_ironsights_lenny.mdl", bone = "HuntingRifleBase", rel = "", pos = Vector(-8.85, 30.5, .36), angle = Angle(180, -100, -90), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonermerge = true, active = true},
}


SWEP.LMScopePos = Vector(-5, -4, 3.25)
...
SWEP.WElements = {
	["riotshotgun_wm"] = { type = "Model", model = "models/weapons/riotshotgun_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-5.481, 6.761, -4.428), angle = Angle(-8.37, 0, 180), size = Vector(0.82, 0.82, 0.82), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}
