...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapons/leveraction/shoot.ogg") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.ReloadSound = Sound("weapons/leveraction/reload.ogg")
...
SWEP.FireModeName = "Shell" --Change to a text value to override it
...
SWEP.Primary.RangeFalloff = .6 -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/leveraction/c_leveraction_len.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-2.758, 3.115, 1.983)
SWEP.IronSightsAng = Vector(0, 0, 0)

--[[INSPECTION]]--
SWEP.InspectPos = Vector(10, -5, -2)--Vector(0,0,0) --Replace with a vector, in style of ironsights position, to be used for inspection
...
SWEP.WElements = {
	["lever"] = { type = "Model", model = "models/weapons/leveraction/c_leveraction_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-0.376, 3.519, -6.349), angle = Angle(-6.595, 0, 180), size = Vector(1.029, 1.029, 1.029), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
