...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("huntingshotgun/shoot.ogg") -- This is the sound of the weapon, when you shoot.
...
--SWEP.Primary.ReloadSound = Sound("huntingshotgun/reload.ogg")
...
--Recoil Related
SWEP.Primary.KickUp = 6.7 -- This is the maximum upwards recoil (rise)
...
--Range Related
SWEP.Primary.Range = (100 * 3) -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
SWEP.CrouchAccuracyMultiplier = .5 --Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
--Movespeed
...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/huntingshotgun/c_huntingshotgun_reworked_len.mdl"
...
SWEP.ShellTime = .55 -- For shotguns, how long it takes to insert a shell.
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(17.27, -0.473, -4.736)
SWEP.RunSightsAng = Vector(-10, 49.967, 0)
...
SWEP.IronSightsPos = Vector(-2.9, 2.115, 1.5)
SWEP.IronSightsAng = Vector(0, 0, 0)

--[[INSPECTION]]--
SWEP.InspectPos = Vector(13, -10, -3)--Vector(0,0,0) --Replace with a vector, in style of ironsights position, to be used for inspection
...
SWEP.WElements = {
	["huntingshotgun"] = { type = "Model", model = "models/weapons/huntingshotgun/c_huntingshotgun_reworked_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-4.724, 2.861, -3.306), angle = Angle(-12.494, 0, 180), size = Vector(0.732, 0.763, 0.732), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
