...
SWEP.PrintName              = "Laser Rifle (w/ Scoped)"       -- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM_Semi = 110 -- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.ScopedTracerForward = 18
SWEP.ScopedTracerUp = 2
SWEP.ScopedTracerRight = -13

SWEP.TracerForward = 18
SWEP.TracerUp = 2
SWEP.TracerRight = -5
...
SWEP.VElements = {
	["scope"] = { type = "Model", model = "models/weapons/fallout4guns/lasermusket_scope_test.mdl", bone = "laserrifle", rel = "", pos = Vector(0.544, 2.757, -0.682), angle = Angle(176.854, -101.592, -92.995), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["ref"] = { type = "Model", model = "models/illusion/fwp/w_laserrifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(6.947, 0.49, -1.956), angle = Angle(-171.728, 171.147, 0), size = Vector(0.735, 0.735, 0.735), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["scope"] = { type = "Model", model = "models/weapons/fallout4guns/lasermusket_scope_test.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(6.922, 1.233, -5.435), angle = Angle(-171.038, 173.384, 1.243), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
