...
SWEP.PrintName              = "Prototype Plasma Rifle"       -- Weapon name (Shown on HUD)
...
SWEP.PercentageDamage = .035 -- Percentage of hp which is added on to damage
SWEP.Plasma = false
...
--[[VIEWMODEL]]--
SWEP.ViewModel			    = "models/weapons/cgc/c_autogauss_len.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-3.69, 0, 1.1)
...
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/weapons/cgc/c_autogauss_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-4.736, 3.671, -5.034), angle = Angle(-8.929, 0, 180), size = Vector(0.736, 0.736, 0.736), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

sound.Add( {
	name = "ProtGauss.Insert",
	channel = CHAN_STATIC,
	volume = 1.0,
	level = 80,
	pitch = {95, 110},
	sound = "protgauss/BatteryIn.mp3"
} )

sound.Add( {
	name = "ProtGauss.Eject",
	channel = CHAN_STATIC,
	volume = 1.0,
	level = 80,
	pitch = {95, 110},
	sound = "protgauss/BatteryOut.mp3"
} )
