...
SWEP.PrintName              = "Modified Tribeam"       -- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapons/laserrifle/shoot.mp3") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.ReloadSound = Sound("weapons/laserrifle/reload.mp3")

SWEP.UseDefaultTracerPosition = false

SWEP.ScopedTracerForward = 26
SWEP.ScopedTracerUp = 2
SWEP.ScopedTracerRight = -13

SWEP.TracerForward = 26
SWEP.TracerUp = -3
SWEP.TracerRight = -5
...
SWEP.Primary.RangeFalloff = 0.55 -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/LaserRifle/c_laser_rifle_len.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-7.24, 0, -0.04)
...
SWEP.VElements = {
	["diffuser"] = { type = "Model", model = "models/weapons/tribeam/diffuser.mdl", bone = "Laser Rifle", rel = "", pos = Vector(-8.032, 26.979, -8.898), angle = Angle(-0.317, 80.686, -90), size = Vector(1.212, 1.212, 1.212), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.LMScopePos = Vector(-7.2, -11, -0.86)
...
SWEP.WElements = {
	["diffuser"] = { type = "Model", model = "models/weapons/tribeam/diffuser.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-3.754, -3.652, -2.862), angle = Angle(0, 0, 0), size = Vector(0.656, 0.656, 0.656), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["laser_rifle_wm"] = { type = "Model", model = "models/weapons/laserrifle/c_laser_rifle_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-2.257, 5.421, -6.845), angle = Angle(0, 0, -180), size = Vector(0.601, 0.601, 0.601), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}
