...
SWEP.Category               = "Fallout SWEPs - Sniper Rifles" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName              = "YCS/186"       -- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapons/gauss_rifle/shoot.ogg") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = nil -- This is the sound of the weapon, when silenced.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = 700 -- Damage, in standard damage points.
SWEP.Primary.DamageTypeHandled = true --true will handle damagetype in base
SWEP.Primary.DamageType = DMG_DISSOLVE --See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.  Leave nil to autodetect.  DMG_AIRBOAT opens doors.
...
SWEP.Primary.ReloadSound = Sound("weapons/gauss_rifle/reload.ogg") -- This is the sound of the weapon, when you shoot.
...
SWEP.FireModeName = "Projectile" --Change to a text value to override it
...
--Firing Cone Related
SWEP.Primary.Spread = .2--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .000000001 -- Ironsight accuracy, should be the same for shotguns
...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/ycsgaussrifle/c_ycs_gauss_rifle_len.mdl" --Viewmodel path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(0, -7.204, -0.826) --Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng = Vector(-9.848, 39.138, 0) --Change this, using SWEP Creation Kit preferably
...
SWEP.IronSightsPos = Vector(-5.56, -4, 0.12) --Change this, using SWEP Creation Kit preferably
SWEP.IronSightsAng = Vector(0, 0, 0) --Change this, using SWEP Creation Kit preferably

--[[INSPECTION]]--
SWEP.InspectPos = Vector(2, -5, -1.8)--Vector(0,0,0) --Replace with a vector, in style of ironsights position, to be used for inspection
...
SWEP.ProceduralReloadTime = 2.35 --Procedural reload time?
--[[HOLDTYPES]]--
...
SWEP.MuzzleFlashEffect = "HunterMuzzleFlash" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.
SWEP.SmokeParticle = nil --Smoke particle (ID within the PCF), defaults to something else based on holdtype; "" to disable
SWEP.EjectionSmokeEnabled = false --Disable automatic ejection smoke
--Shell eject override
SWEP.LuaShellEject = false --Enable shell ejection through lua?
SWEP.LuaShellEjectDelay = .18 --The delay to actually eject things
...
--Impact Effects
SWEP.ImpactEffect = "effect_fo3_alienatomizerhit"--Impact Effect
...
--[[ATTACHMENTS]]--
SWEP.VElements = {
	["hr_scope"] = { type = "Model", model = "models/weapons/attachments/gaussrifle_scope.mdl", bone = "Body", rel = "", pos = Vector(4.55, -5.5, -0.25), angle = Angle(180, -100, -90), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = true },
	--["hr_scope_rt"] = { type = "Model", model = "models/rtcircle.mdl", bone = "Body", rel = "", pos = Vector(4.1, -2.916, -0.401), angle = Angle(0, -99.737, 180), size = Vector(0.28, 0.28, 0.28), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}, bonemerge = false, active = false },
}


--Export from SWEP Creation Kit.  For each item that can/will be toggled, set active=false in its individual table
SWEP.WElements = {
	["scope"] = { type = "Model", model = "models/weapons/attachments/gaussrifle_scope.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(7.689, 0.086, -8.487), angle = Angle(-7.532, 0, 180), size = Vector(1.087, 1.087, 1.087), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["gaussrifle"] = { type = "Model", model = "models/weapons/ycsgaussrifle/c_ycs_gauss_rifle_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-3.549, 5.745, -7.059), angle = Angle(-6.792, 0, 180), size = Vector(1.046, 1.046, 1.046), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
