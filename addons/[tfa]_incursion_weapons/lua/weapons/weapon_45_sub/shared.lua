...
SWEP.PrintName              = ".45 Sub-Machine gun"       -- Weapon name (Shown on HUD)
...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/45sub/c_45sub_len.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-6.281, 0, 1.919)
...
SWEP.WElements = {
	["45"] = { type = "Model", model = "models/weapons/45sub/c_45sub_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-9.775, 6.232, -4.415), angle = Angle(-9.546, 0, 180), size = Vector(0.953, 0.953, 0.953), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
