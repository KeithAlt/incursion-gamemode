...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/laserrifle_scoped/c_laser_sniperifle_len.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-7.24, 0, -3.04)
...
SWEP.WElements = {
	["lasersniper"] = { type = "Model", model = "models/weapons/laserrifle_scoped/c_laser_sniperifle_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-1.275, 6.609, -6.185), angle = Angle(-9.532, 0, 180), size = Vector(0.875, 0.875, 0.875), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
