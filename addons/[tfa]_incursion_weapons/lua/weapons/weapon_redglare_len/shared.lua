...
--Range Related
SWEP.Primary.Range = 32000 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/Fallout4Guns/c_redglare_len.mdl" --Viewmodel path
...
SWEP.RunSightsAng = Vector(-15.065, 19.504, 0)--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-3.75, 0, -1)
SWEP.IronSightsAng = Vector(0, 0, 0)
--[[INSPECTION]]--
SWEP.InspectPos = Vector(8,-6,-2)--Vector(0,0,0) --Replace with a vector, in style of ironsights position, to be used for inspection
...
SWEP.WElements = {
	["red glare"] = { type = "Model", model = "models/weapons/Fallout4Guns/c_redglare_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-17.303, 9.72, -5.803), angle = Angle(-8.273, 2.947, 180), size = Vector(0.644, 0.644, 0.644), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.ProjectileEntity 	= "redglare_proj" --Entity to shoot
