...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("mg42/mg42_shoot_cgc.wav") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			    = "models/weapons/cgc/c_mg42_len.mdl" --Viewmodel path
...
SWEP.WElements = {
	["m60"] = { type = "Model", model = "models/weapons/cgc/c_mg42_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-.5, 4.072, -8.5), angle = Angle(-5, 0, 180), size = Vector(0.769, 0.769, 0.769), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
