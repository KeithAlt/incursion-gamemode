...
SWEP.Category               = "Fallout SWEPs - Rifles" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName              = "Rat Slayer"       -- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("ratslayer/fire.mp3") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.ReloadSound = Sound("weapons/huntingrifle/boltopen.wav")
...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/ratslayer/c_ratslayer_len.mdl" --Viewmodel path
...
SWEP.RunSightsAng = Vector(0, 0, 200) --Change this, using SWEP Creation Kit preferably
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-3.8, -2.149, 0.8)
SWEP.IronSightsAng = Vector(0, 0, 0)
--[[INSPECTION]]--
SWEP.InspectPos = Vector(2, -5, 0)--Vector(0,0,0) --Replace with a vector, in style of ironsights position, to be used for inspection
...
SWEP.VElements = {
	["hr_scope"] = { type = "Model", model = "models/weapons/attachments/varmintrifle_scope.mdl", bone = "Varmint Rifle", rel = "", pos = Vector(6.686, -6.986, 0.016), angle = Angle(0, 78.383, 90), size = Vector(0.792, 0.792, 0.792), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = true },
	--["hr_scope_rt"] = { type = "Model", model = "models/rtcircle.mdl", bone = "Varmint Rifle", rel = "", pos = Vector(5.6, -4.152, 0.001), angle = Angle(0, -103.541, 180), size = Vector(0.323, 0.323, 0.323), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}, bonemerge = false, active = false }
	["silencer"] = { type = "Model", model = "models/weapons/attachments/infiltrator_sup.mdl", bone = "Varmint Rifle", rel = "", pos = Vector(8.456, -28.317, 0.028), angle = Angle(-119.265, -9.902, 0), size = Vector(0.633, 0.633, 0.633), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.LMScopePos = Vector(-3.76, 0, 0.8)
...
SWEP.WElements = {
	["varmintrifle"] = { type = "Model", model = "models/weapons/ratslayer/c_ratslayer_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-1.292, 5.157, -4.807), angle = Angle(-13.282, 0, 180), size = Vector(1.103, 1.103, 1.103), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["hr_scope_wm"] = { type = "Model", model = "models/weapons/attachments/varmintrifle_scope.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(6.139, 0.888, -6.232), angle = Angle(-13.947, 0, 180), size = Vector(0.955, 0.955, 0.955), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = true }
}
