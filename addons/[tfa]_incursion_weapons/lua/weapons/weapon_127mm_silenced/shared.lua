...
SWEP.PrintName              = "Silenced 12.7mm SMG"       -- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapons/infiltrator/fire_silenced.ogg") -- This is the sound of the weapon, when you shoot.
...
SWEP.VElements = {
	["sup"] = { type = "Model", model = "models/weapons/attachments/infiltrator_sup.mdl", bone = "127mm", rel = "", pos = Vector(6.519, -13.735, -0.224), angle = Angle(0, -10.329, 0), size = Vector(1.024, 0.669, 1.024), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

--Export from SWEP Creation Kit.  For each item that can/will be toggled, set active=false in its individual table
SWEP.WElements = {
	["sup"] = { type = "Model", model = "models/weapons/attachments/infiltrator_sup.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(16.462, 1.501, -4.64), angle = Angle(180, -90.473, 8.552), size = Vector(0.89, 0.532, 0.89), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["127"] = { type = "Model", model = "models/weapons/127mm/c_127mm_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-5.311, 8.494, -6.332), angle = Angle(-6.896, 0, 180), size = Vector(0.847, 0.847, 0.847), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
