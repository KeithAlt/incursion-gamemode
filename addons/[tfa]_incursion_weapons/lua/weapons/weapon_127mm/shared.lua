...
SWEP.Category               = "Fallout SWEPs - Sub Machine Guns" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName              = "12.7mm SMG"       -- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapons/45sub/shoot.ogg") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Semi = 47 -- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Burst = nil -- RPM for burst fire, overrides semi.  This is in Rounds Per Minute / RPM
SWEP.Primary.DryFireDelay = nil --How long you have to wait after firing your last shot before a dryfire animation can play.  Leave nil for full empty attack length.  Can also use SWEP.StatusLength[ ACT_VM_BLABLA ]
SWEP.Primary.BurstDelay = nil -- Delay between bursts, leave nil to autocalculate
SWEP.Primary.ReloadSound = Sound("weapons/45sub/reload.ogg")
...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/127mm/c_127mm_len.mdl" --Viewmodel path
SWEP.ViewModelFOV           = 75        -- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip          = false     -- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands = true --Use gmod c_arms system.

SWEP.VMPos = Vector(-4, -3,0) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--[[WORLDMODEL]]--
SWEP.WorldModel         = "models/weapons/w_smg1.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-4.43, 0, 2.5)
...
--[[ATTACHMENTS]]--
-- models/weapons/attachments/square_scope_overlay.mdl
SWEP.VElements = {
	["hr_scope"] = { type = "Model", model = "models/weapons/attachments/9mm_scope.mdl", bone = "9mm", rel = "", pos = Vector(6.353, 0, 0), angle = Angle(180, -100.689, -90.014), size = Vector(0.56, 0.56, 0.56), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	["hr_scope_rt"] = { type = "Model", model = "models/weapons/attachments/square_scope_overlay.mdl", bone = "9mm", rel = "", pos = Vector(7.263, -1.451, -0.029), angle = Angle(90, -10.516, 0), size = Vector(0.449, 0.449, 0.545), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}, bonemerge = false, active = false }
}
SWEP.LMScopePos = Vector(-5.04, -1, 0.25)
SWEP.KBScopeAng = Angle(0, 0 , 0)

--Export from SWEP Creation Kit.  For each item that can/will be toggled, set active=false in its individual table
SWEP.WElements = {
	["45"] = { type = "Model", model = "models/weapons/127mm/c_127mm_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-9.947, 8.704, -6.853), angle = Angle(-9.546, 0, 180), size = Vector(0.953, 0.953, 0.953), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}


SWEP.Attachments = {
	[1] = { offset = { 0, 0 }, atts = { "fallout_reflex"}, order = 1 },
}
