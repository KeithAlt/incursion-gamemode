...
SWEP.PrintName              = "Enclave Multiplas Rifle"       -- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM = 300 -- This is in Rounds Per Minute / RPMits
...
SWEP.Primary.IronAccuracy = 0.047 -- Ironsight accuracy, should be the same for shotguns
...
SWEP.Primary.SpreadIncrement = 1/4.5 --What percentage of the modifier is added on, per shot.  Example val: 1/3.5
...
--[[VIEWMODEL]]--
SWEP.ViewModel              = "models/weapons/multiplas/c_multiplas_len.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-6.401, 0, 0.479)
...
SWEP.WElements = {
	["multiplas"] = { type = "Model", model = "models/weapons/multiplas/c_multiplas_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-4.091, 6.967, -7.388), angle = Angle(0.182, -2.284, 180), size = Vector(1.034, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
