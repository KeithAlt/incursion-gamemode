...
SWEP.PrintName              = "Mini Launcher"       -- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapons/missilelauncher/shoot.ogg") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM = 5000 -- This is in Rounds Per Minute / RPM
...
SWEP.Primary.ReloadSound = Sound("weapons/missilelauncher/reload.ogg")
...
SWEP.FireModeName = "Missile" --Change to a text value to override it
...
SWEP.Primary.Ammo = "Rocket" -- Rocket -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
SWEP.Primary.KickHorizontal = 6-- This is the maximum sideways recoil (no real term)
...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/customorders3/c_minilauncher_len.mdl" --Viewmodel path
...
SWEP.RunSightsAng = Vector(-11.065, 29.504, 0)--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-3.75, 0, 0.5)
...
SWEP.WElements = {
	["ml"] = { type = "Model", model = "models/weapons/customorders3/c_minilauncher_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-0.297, 4.603, -7.402), angle = Angle(-6.45, 0, 180), size = Vector(1.021, 1.021, 1.021), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.ProjectileEntity 	= "minilauncher_proj" --Entity to shoot
SWEP.ProjectileVelocity = 1250 --Entity to shoot's velocity
SWEP.ProjectileModel 	= "models/weapons/w_missile_launch.mdl" --Entity to shoot's model
