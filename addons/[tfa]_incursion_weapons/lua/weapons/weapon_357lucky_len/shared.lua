...
SWEP.PrintName              = "Lucky"       -- Weapon name (Shown on HUD)
SWEP.Type					= "Unique Pistol"
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("357/shoot.mp3") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.IronAccuracy = .0010 -- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel          	= "models/weapons/357Pistol/c_357Lucky_len.mdl" --Viewmodel path
SWEP.ViewModelFOV           = 90        -- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip          = false     -- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands 				= true --Use gmod c_arms system.
SWEP.VMPos = Vector(1,0,-.5) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
SWEP.IronSightsPos = Vector(-2.215, -2.089, 0.616)
...
SWEP.WElements = {
	["357"] = { type = "Model", model = "models/weapons/357Pistol/c_357Lucky_len.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-0.905, 3.16, -5.363), angle = Angle(0, 0, 180), size = Vector(0.864, 0.864, 0.864), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
