...
SWEP.VElements = {
	["asdasd"] = { type = "Model", model = "models/weapons/attachments/varmintrifle_scope.mdl", bone = "varmintrifle", rel = "", pos = Vector(2.615, -0.468, 0.158), angle = Angle(-0.22, 78.932, 93.295), size = Vector(0.718, 0.718, 0.718), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

--Export from SWEP Creation Kit.  For each item that can/will be toggled, set active=false in its individual table
SWEP.WElements = {
	["dsc"] = { type = "Model", model = "models/weapons/attachments/varmintrifle_scope.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.007, 0.243, -6.641), angle = Angle(-165.922, -179.437, -0.593), size = Vector(0.943, 0.943, 0.943), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["asdasd"] = { type = "Model", model = "models/illusion/fwp/w_varmintrifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(6.691, 0.333, -1.762), angle = Angle(-166.204, 180, 0), size = Vector(0.972, 0.972, 0.972), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.Attachments = {}
