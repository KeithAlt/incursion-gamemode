...
SWEP.PrintName              = "Molemen Shotgun"       -- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage = 2.5 -- Damage, in standard damage points.
...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/fml/fallout/c_basically_bosg.mdl" --Viewmodel path
