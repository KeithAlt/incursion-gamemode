...
SWEP.PrintName				= "Plasma Defender"		-- Weapon name (Shown on HUD)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/plasmadefender/c_plasmadefender_len.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 56		-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands = true --Use gmod c_arms system.
SWEP.VMPos = Vector(-2,7,0) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/plasmadefender/c_plasmadefender_len.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-8.9, 5, 1)
