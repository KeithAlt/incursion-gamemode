...
SWEP.PrintName              = "Laser Sniper Rifle"       -- Weapon name (Shown on HUD)
...
--[[VIEWMODEL]]--
SWEP.ViewModel          	= "models/weapons/lasersniperrifle/c_laser_sniperifle_len_test.mdl" --Viewmodel path
...
SWEP.VMPos_Additive = true --Set to false for an easier time using VMPos. If true, VMPos will act as a constant delta ON TOP OF ironsights, rvzun, whateverelse
...
SWEP.IronSightsPos = Vector(-6.361, -4.182, 0.319)
...
--[[ATTACHMENTS]]--
SWEP.VElements = {
	["hr_scope"] = { type = "Model", model = "models/weapons/attachments/lasersniperrifle_scope.mdl", bone = "LaserSniperRifle", rel = "", pos = Vector(9.17, -14.28, 0.054), angle = Angle(0, 79.203, 90), size = Vector(0.941, 0.941, 0.941), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = true },
}


--Export from SWEP Creation Kit.  For each item that can/will be toggled, set active=false in its individual table
SWEP.WElements = {
	["laser_rifle_wm"] = { type = "Model", model = "models/weapons/lasersniperrifle/c_laser_sniperifle_len_test.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-2.257, 5.421, -6.845), angle = Angle(0, 0, -180), size = Vector(0.601, 0.601, 0.601), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["hr_scope_wm"] = {  type = "Model", model = "models/weapons/attachments/lasersniperrifle_scope.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(9.218, 1.085, -6.193), angle = Angle(0, 0, 180), size = Vector(0.374, 0.374, 0.374), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true },
}
