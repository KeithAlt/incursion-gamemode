...
--Firing Cone Related
SWEP.Primary.Spread = .0500--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.MuzzleFlashEffect = "fo3_muzzle_laer" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.
