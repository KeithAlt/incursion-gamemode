...
function ENT:Initialize()
	...
	self:SetModel("models/Halokiller38/fallout/weapons/Melee/tomahawk.mdl")
...
function ENT:Use(activator, caller)
	...
	if (activator:IsPlayer()) then
		if activator:GetWeapon("weapon_throwingtomahawk") == NULL then
			activator:Give("weapon_throwingtomahawk")
		else
