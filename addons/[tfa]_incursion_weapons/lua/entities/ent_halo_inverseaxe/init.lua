...
function ENT:Initialize()
	...
	self:SetModel("models/Halokiller38/fallout/weapons/Melee/inversalaxe.mdl")
...
function ENT:Use(activator, caller)
	...
	if (activator:IsPlayer()) then
		if activator:GetWeapon("weapon_throwinginverseaxe") == NULL then
			activator:Give("weapon_throwinginverseaxe")
		else
