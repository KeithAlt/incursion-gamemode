...
function ENT:Initialize()
	...
	self:SetModel("models/Halokiller38/fallout/weapons/Melee/throwinghatchet.mdl")
...
function ENT:Use(activator, caller)
	...
	if (activator:IsPlayer()) then
		if activator:GetWeapon("weapon_throwingthrowinghatchet") == NULL then
			activator:Give("weapon_throwingthrowinghatchet")
		else
