...
function ENT:Initialize()
	...
	self:SetModel("models/Halokiller38/fallout/weapons/Melee/protonaxe.mdl")
...
function ENT:Use(activator, caller)
	...
	if (activator:IsPlayer()) then
		if activator:GetWeapon("weapon_throwingprotonaxe") == NULL then
			activator:Give("weapon_throwingprotonaxe")
		else
