...
function ENT:Initialize()
	...
	self.Entity:SetModel("models/halokiller38/fallout/weapons/mines/pulsemine.mdl")
...
function ENT:Explosion()
	...
	local effectdata = EffectData()
		...
		effectdata:SetRadius(100)		// What texture it hits
		effectdata:SetMagnitude(30)			// Length of explosion trails
	...
	util.BlastDamage(self.Entity, self.Owner, self.Entity:GetPos(), 900, 50	)
