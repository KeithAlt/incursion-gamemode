...
SWEP.PrintName = "9mm Pistol (Modded)"
...
SWEP.VElements = {
	["pistol"] = { type = "Model", model = "models/halokiller38/fallout/weapons/pistols/9mmextclipscp.mdl", bone = "v_weapon.USP_Parent", rel = "", pos = Vector(0, 1.024, 3.086), angle = Angle(0, 0, -90), size = Vector(1.118, 1.118, 1.118), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["pistol"] = { type = "Model", model = "models/halokiller38/fallout/weapons/pistols/9mmextclipscp.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.019, 1.547, 0.742), angle = Angle(180, -95.834, 6.809), size = Vector(0.924, 0.924, 0.924), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
