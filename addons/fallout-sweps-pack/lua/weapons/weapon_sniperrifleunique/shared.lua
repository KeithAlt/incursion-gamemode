...
SWEP.PrintName = "Gobi Campaign Scout Rifle"
...
SWEP.VElements = {
	["rifle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/sniperrifles/sniperrifleunique.mdl", bone = "v_weapon.sg550_Parent", rel = "", pos = Vector(0.016, 2.055, 8.925), angle = Angle(0, 0, -88.85), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["sniper"] = { type = "Model", model = "models/halokiller38/fallout/weapons/sniperrifles/sniperrifleunique.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-3.342, 0.746, 4.41), angle = Angle(0, 90, -170.364), size = Vector(1.013, 1.013, 1.013), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
