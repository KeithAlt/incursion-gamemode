...
SWEP.VElements = {
	["rifle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/sniperrifles/ratslayer.mdl", bone = "v_weapon.scout_Parent", rel = "", pos = Vector(-0.077, 2.964, 4.452), angle = Angle(0, 0, -90), size = Vector(1.092, 1.092, 1.092), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/sniperrifles/ratslayer.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0, 0.805, 3.654), angle = Angle(0, 90.384, -172.646), size = Vector(1.092, 1.092, 1.092), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.Primary.Sound = Sound("weapon_varmint1.wav") 
