...
SWEP.PrintName = "Trail Carbine (Modded)"
...
SWEP.VElements = {
	["rifle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/rifles/trailcarbinescoped.mdl", bone = "v_weapon.xm1014_Parent", rel = "", pos = Vector(0, 0.822, 5.257), angle = Angle(0, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/rifles/trailcarbinescoped.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0.078, 0.647, 1.562), angle = Angle(180, -90, 3.569), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.Primary.Sound = Sound("weapon_trailcarbine1.ogg") 
