...
SWEP.PrintName = "Varmint Rifle (Modded)"
...
SWEP.VElements = {
	["rifle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/rifles/varmintriflescpext.mdl", bone = "v_weapon.scout_Parent", rel = "", pos = Vector(-0.077, 1.858, 4.452), angle = Angle(0, 0, -90), size = Vector(1.092, 1.092, 1.092), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/rifles/varmintriflescpext.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0, 0.885, 2.424), angle = Angle(0, 90.384, -171.732), size = Vector(1.092, 1.092, 1.092), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.Primary.Sound = Sound("weapon_varmint1.ogg") 
