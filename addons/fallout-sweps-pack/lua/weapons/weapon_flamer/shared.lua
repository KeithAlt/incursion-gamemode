...
SWEP.VElements = {
	["flamer"] = { type = "Model", model = "models/halokiller38/fallout/weapons/heavy weapons/flamer.mdl", bone = "Base", rel = "", pos = Vector(16.903, 2.569, -16.827), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
