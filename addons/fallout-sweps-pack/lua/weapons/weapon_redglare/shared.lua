...
SWEP.VElements = {
	...
	["minigun"] = { type = "Model", model = "models/halokiller38/fallout/weapons/rocketlaunchers/redglare.mdl", bone = "Base", rel = "", pos = Vector(6.107, -5.834, -22.017), angle = Angle(0, -180, -180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }

}

SWEP.WElements = {

	["minigun"] = { type = "Model", model = "models/halokiller38/fallout/weapons/rocketlaunchers/redglare.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-6.197, -0.051, -8.462), angle = Angle(-1.377, 86.441, -77.787), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
...
SWEP.ReloadSound = "weapon_redglare_reload.ogg"
...
function SWEP:FireFrag()
	...
	local Frag = ents.Create("fswp_rocket")
...
function SWEP:SecondaryAttack()
	...
	//The variable "self.ScopeLevel" tells how far the scope has zoomed.
...
if((self.ScopeLevel or 0) > 0) then
