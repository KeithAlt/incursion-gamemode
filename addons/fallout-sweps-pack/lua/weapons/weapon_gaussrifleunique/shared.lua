...
SWEP.VElements = {
	["rifle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/energy weapons/gaussrifleunique.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(0.513, 3.828, 14.901), angle = Angle(0, 0, -90), size = Vector(1.241, 1.241, 1.241), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/energy weapons/gaussrifleunique.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-9.594, 0, 6.846), angle = Angle(-180, -91.026, 10.626), size = Vector(1.32, 1.32, 1.32), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.ReloadSound = "weapon_gaussrifle_reload.ogg"

SWEP.Base = "weapon_base"

SWEP.Primary.Sound = Sound("weapon_gaussrifle1.ogg") 
