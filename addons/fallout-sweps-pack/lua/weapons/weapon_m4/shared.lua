...
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/assaultrifles/assaultcarbine.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-3.194, 0.762, 2.46), angle = Angle(0, 90, -175.092), size = Vector(1.166, 1.166, 1.166), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
