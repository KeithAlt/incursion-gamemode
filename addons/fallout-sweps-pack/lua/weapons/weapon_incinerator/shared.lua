...
SWEP.Purpose		= "Set stuff on fire from a long distance"
...
SWEP.VElements = {
	["minigun"] = { type = "Model", model = "models/halokiller38/fallout/weapons/heavy weapons/heavyincenerator.mdl", bone = "Base", rel = "", pos = Vector(5.322, 16.882, -29.636), angle = Angle(-180, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["minigun"] = { type = "Model", model = "models/halokiller38/fallout/weapons/heavy weapons/heavyincenerator.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-2.536, 1.774, 16.107), angle = Angle(0, 90, -177.709), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
