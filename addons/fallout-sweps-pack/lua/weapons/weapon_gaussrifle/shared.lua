...
SWEP.VElements = {
	["rifle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/energy weapons/gaussrifle.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(0.513, 3.828, 12.024), angle = Angle(0, 0, -90), size = Vector(1.241, 1.241, 1.241), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/energy weapons/gaussrifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-6.902, 0, 7.059), angle = Angle(-180, -91.026, 10.626), size = Vector(1.32, 1.32, 1.32), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
