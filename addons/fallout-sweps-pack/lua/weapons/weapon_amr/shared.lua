...
SWEP.VElements = {
	["rifle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/sniperrifles/antimaterielrifle.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(0.513, 2.368, 10.546), angle = Angle(0, 0, -90), size = Vector(1.241, 1.241, 1.241), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/sniperrifles/antimaterielrifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-6.871, 0, 5.178), angle = Angle(-180, -91.026, 10.626), size = Vector(1.32, 1.32, 1.32), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.HoldType= "ar2"
SWEP.Primary.Sound = Sound("weapon_amr1.ogg") 
