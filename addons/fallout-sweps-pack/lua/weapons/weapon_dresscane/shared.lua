...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/dresscane.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-0.318, -0.908, 55.874), angle = Angle(-2.395, 87.315, 177.027), size = Vector(1.8, 1.8, 1.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
