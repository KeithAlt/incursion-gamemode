...
SWEP.VElements = {
	["rifle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/assaultrifles/marksmancarbinea.mdl", bone = "v_weapon.sg552_Parent", rel = "", pos = Vector(0.153, 1.985, 6.58), angle = Angle(0.711, 0, -88.625), size = Vector(1.399, 1.399, 1.399), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/assaultrifles/marksmancarbinea.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-1.497, 0.861, 3.838), angle = Angle(0, 91.38, -170.941), size = Vector(1.399, 1.399, 1.399), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
