...
SWEP.PrintName = "9mm Submachinegun"
...
SWEP.WElements = {
	["smg"] = { type = "Model", model = "models/halokiller38/fallout/weapons/smgs/9mmsmg.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.47, 0.948, 1.72), angle = Angle(0, 90, -167.956), size = Vector(1.003, 1.003, 1.003), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
