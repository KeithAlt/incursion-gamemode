...
SWEP.VElements = {
	["binoculars"] = { type = "Model", model = "models/halokiller38/fallout/weapons/misc/binoculars.mdl", bone = "ValveBiped.Grenade_body", rel = "", pos = Vector(-1.03, 4.231, -2.78), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["mine"] = { type = "Model", model = "models/halokiller38/fallout/weapons/misc/binoculars.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.812, 5.522, -2.879), angle = Angle(0, -68.381, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
