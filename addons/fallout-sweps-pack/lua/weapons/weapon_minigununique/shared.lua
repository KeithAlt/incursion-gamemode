...
SWEP.VElements = {
	["minigun"] = { type = "Model", model = "models/halokiller38/fallout/weapons/heavy weapons/minigununique.mdl", bone = "Base", rel = "", pos = Vector(2.746, 1.358, -25.778), angle = Angle(-180, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["minigun"] = { type = "Model", model = "models/halokiller38/fallout/weapons/heavy weapons/minigununique.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.029, 0.691, 0.606), angle = Angle(0, 90, -177.709), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.Slot = 4;
SWEP.Purpose = "";
...
SWEP.ReloadSound = Sound("weapon_minigun_reload.ogg");
SWEP.SlotPos = 0;
SWEP.Instructions = "Hold left click to fire.";
SWEP.AutoSwitchFrom = false;
SWEP.base = "weapon_base";
SWEP.Category = "Fallout SWEPs Uniques";
SWEP.DrawAmmo = true;
SWEP.PrintName = "CZ57 Avenger";
SWEP.UseHands = true
...
sound = "weapon_minigun_windup.mp3"
})
...
sound = "weapon_minigun_winddown.mp3"
})
...
sound = "weapon_minigun_reload.ogg"
})
