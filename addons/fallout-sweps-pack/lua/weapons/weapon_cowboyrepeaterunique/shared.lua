...
SWEP.PrintName = "La Longue Carabine"
...
SWEP.VElements = {
	["rifle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/rifles/cowboyrepeaterunique.mdl", bone = "v_weapon.xm1014_Parent", rel = "", pos = Vector(0.165, 0.99, 9.838), angle = Angle(0, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/halokiller38/fallout/weapons/rifles/cowboyrepeaterunique.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-4.112, 0.398, 2.188), angle = Angle(180, -90, 4.8), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
