...
SWEP.VElements = {
	...
	["minigun"] = { type = "Model", model = "models/halokiller38/fallout/weapons/rocketlaunchers/missilelauncher.mdl", bone = "Base", rel = "", pos = Vector(-6.376, 6.907, -21.243), angle = Angle(4.975, -180, -83.953), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }

}

SWEP.WElements = {

	["minigun"] = { type = "Model", model = "models/halokiller38/fallout/weapons/rocketlaunchers/missilelauncher.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-2.332, -12.759, 1.284), angle = Angle(-180, -85.628, -161.023), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
...
SWEP.ReloadSound = "weapon_missilelauncher_reload.ogg"
...
function SWEP:FireFrag()
	...
	local Frag = ents.Create("rpg_missile")
	...
	Frag:SetSaveValue("m_flDamage", 250)
