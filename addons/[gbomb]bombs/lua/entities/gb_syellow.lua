...
function ENT:Use( activator, caller )
	...
	if !activator:KeyDown( IN_RELOAD ) then
		...
		activator:SetNWInt("ammo_syellow", activator:GetNWInt("ammo_syellow") + 1)

		if !activator:HasWeapon( "weapon_gb_syellow" ) then
			activator:Give("weapon_gb_syellow")
		end
		self:Remove()
	end
end
