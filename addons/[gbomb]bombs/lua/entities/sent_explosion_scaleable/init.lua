...
function ENT:Initialize()
	...
	timer.Simple(0.1, function() util.Effect("effect_explosion_scaleable", effectdata) end)
	...
	timer.Simple(0.12, function() util.BlastDamage(self.Entity, self.Owner, self.Position, BlastRadius, 100*self.BlastScale) end)
	timer.Simple(0.12, function() util.ScreenShake(self.Position, 15, 5, 0.6*self.EffectScale, 1200*self.BlastScale) end)
