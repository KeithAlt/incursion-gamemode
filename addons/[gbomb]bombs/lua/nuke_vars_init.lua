if SERVER then
	...
	if GetConVarString("nuke_yield") == "" then --if one of them doesn't exists, then they all probably don't exist
		...
		CreateConVar("nuke_breakconstraints", 0, bit.bor(FCVAR_NOTIFY, FCVAR_REPLICATED, FCVAR_SERVER_CAN_EXECUTE))
		CreateConVar("nuke_disintegration", 0, bit.bor(FCVAR_NOTIFY, FCVAR_REPLICATED, FCVAR_SERVER_CAN_EXECUTE))
		CreateConVar("nuke_damage", 150, bit.bor(FCVAR_NOTIFY, FCVAR_REPLICATED, FCVAR_SERVER_CAN_EXECUTE))
		CreateConVar("nuke_epic_blastwave", 1, bit.bor(FCVAR_NOTIFY, FCVAR_REPLICATED, FCVAR_SERVER_CAN_EXECUTE))
		CreateConVar("nuke_radiation_duration", 180, bit.bor(FCVAR_NOTIFY, FCVAR_REPLICATED, FCVAR_SERVER_CAN_EXECUTE))
		CreateConVar("nuke_radiation_damage", 2, bit.bor(FCVAR_NOTIFY, FCVAR_REPLICATED, FCVAR_SERVER_CAN_EXECUTE))
	end
