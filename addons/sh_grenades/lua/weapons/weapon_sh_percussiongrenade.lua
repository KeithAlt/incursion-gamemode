...
if (CLIENT) then
	SWEP.PrintName = "Percussion Grenade"
	SWEP.Instructions = "Pull the pin and throw."
	SWEP.Purpose = "A grenade which explodes on impact."
	SWEP.WepSelectIcon = surface.GetTextureID("weapons/weapon_sh_percussiongrenade")
