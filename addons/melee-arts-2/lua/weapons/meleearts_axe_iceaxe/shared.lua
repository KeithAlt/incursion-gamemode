...
SWEP.Purpose = "Recovered from a lost ship"
...
SWEP.WepName="meleearts_axe_iceaxe"
...
SWEP.DmgMin2 = 4
SWEP.DmgMax2 = 15
SWEP.ThrowModel = "models/models/danguyen/w_iceaxe.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["axe"] = { type = "Model", model = "models/models/danguyen/w_iceaxe.mdl", bone = "smdimport", rel = "", pos = Vector(0.3, 0.518, -7.792), angle = Angle(0, 17.531, 0), size = Vector(0.885, 0.885, 0.755), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["axe"] = { type = "Model", model = "models/models/danguyen/w_iceaxe.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.335, 1.258, 4.675), angle = Angle(180, 82.986, 8.182), size = Vector(0.885, 0.885, 0.755), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}