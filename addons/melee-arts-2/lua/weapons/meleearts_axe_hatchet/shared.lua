...
SWEP.Purpose = "Good for when you're stuck in the Canadian wilderness"
...
SWEP.WepName="meleearts_axe_hatchet"
...
SWEP.DmgMin2 = 5
SWEP.DmgMax2 = 14
SWEP.ThrowModel = "models/models/danguyen/hatchet.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["axe"] = { type = "Model", model = "models/models/danguyen/hatchet.mdl", bone = "smdimport", rel = "", pos = Vector(0.518, 0, 1.557), angle = Angle(90, 125.065, 0), size = Vector(0.649, 0.649, 0.649), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["axe1"] = { type = "Model", model = "models/models/danguyen/hatchet.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4.675, 1.358, -3.636), angle = Angle(-80.65, -3.507, 0), size = Vector(0.69, 0.69, 0.69), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
