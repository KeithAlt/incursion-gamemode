	...
	timer.Simple(0.3, function()
		if CLIENT then
			...
			if self.Owner:GetNWInt("matier") == 1 then
				self.WElements = {
					["stick"] = { type = "Model", model = "models/weapons/w_stunbaton.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.596, 1.557, -6.753), angle = Angle(87.662, 0, 0), size = Vector(0.95, 0.95, 0.95), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
				}
			elseif self.Owner:GetNWInt("matier") == 2 then
				self.WElements = {
					["stick"] = { type = "Model", model = "models/weapons/w_crowbar.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.596, 1.557, -6.753), angle = Angle(90, 0, 157.792), size = Vector(0.95, 0.95, 0.95), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
				}
