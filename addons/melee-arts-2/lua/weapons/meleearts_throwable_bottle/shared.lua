...
SWEP.Purpose = "A classic stealth gadget."
...
SWEP.WepName="meleearts_throwable_bottle"

--Primary Attack Charge Values
SWEP.OwnerOwnsProjectile = true
SWEP.Explanation = "Stuns any enemy it hits."
SWEP.EntName = "meleeartsbottle"
SWEP.Velocity = 1500
...
SWEP.CanThrow = true
SWEP.ThrowModel = "models/props_junk/garbage_glassbottle003a.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.Impact1Sound="physics/glass/glass_bottle_impact_hard3.wav"
SWEP.Impact2Sound="physics/glass/glass_bottle_impact_hard3.wav"

SWEP.ViewModelBoneMods = {
	["v_weapon.Flashbang_Parent"] = { scale = Vector(0.056, 0.056, 0.056), pos = Vector(0, 0, -3.889), angle = Angle(0, 0, 0) },
	["ValveBiped.Bip01_R_Clavicle"] = { scale = Vector(1, 1, 1), pos = Vector(-2.779, 0, 0), angle = Angle(0, 0, 0) }
}
...
SWEP.VElements = {
	["Smokebomb"] = { type = "Model", model = "models/props_junk/garbage_glassbottle003a.mdl", bone = "v_weapon.Flashbang_Parent", rel = "", pos = Vector(0.619, -0.7, 0), angle = Angle(-31.559, -162.469, -66.624), size = Vector(0.625, 0.625, 0.625), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["Smokebomb"] = { type = "Model", model = "models/props_junk/garbage_glassbottle003a.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.635, 2.596, -3.636), angle = Angle(-8.183, 85.324, -5.844), size = Vector(0.95, 0.95, 0.95), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}