...
SWEP.Purpose = "Catch the big fish"
...
SWEP.WepName="meleearts_spear_harpoon"
...
SWEP.DmgMin2 = 5
SWEP.DmgMax2 = 20
SWEP.ThrowModel = "models/props_junk/harpoon002a.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["spear"] = { type = "Model", model = "models/props_junk/harpoon002a.mdl", bone = "v_me_sledge", rel = "", pos = Vector(0, 0, 0), angle = Angle(92.337, 0, 0), size = Vector(0.56, 0.56, 0.56), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["Pipe"] = { type = "Model", model = "models/props_junk/harpoon002a.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(19.221, 1.557, -4.676), angle = Angle(-12.858, 0, 0), size = Vector(0.69, 0.69, 0.69), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}