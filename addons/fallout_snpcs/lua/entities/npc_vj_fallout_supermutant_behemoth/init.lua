...
function ENT:CustomOnInitialize()
	...
	self:SetCollisionBounds(Vector(-16,-16,0),Vector(16,16,270))
...
if EnemyDistance > 0 && EnemyDistance < 10000 then
    ...
    local randattack = math.random(1,2)
		...
		self.MeleeAttackAngleRadius = 300

		self.MeleeAttackAnimationFaceEnemy = true

		self.MeleeAttackDamage = 85

		self.MeleeAttackDamageAngleRadius = 500

		self.MeleeAttackDamageDistance = 500
        ...
        self.MeleeAttackKnockBack_Forward1 = 400 -- How far it will push you forward | First in math.random

        self.MeleeAttackKnockBack_Forward2 = 500 -- How far it will push you forward | Second in math.random
