SWEP.Author		= "Mailer"
SWEP.Category		= "Mailer's SWEPs"
SWEP.Purpose		= "Breathe fire"
SWEP.Instructions		= "Left-Click: Exhale fire\nReload: Regain Breath"
SWEP.Spawnable		= true
SWEP.AdminSpawnable	= true
SWEP.ViewModel			= "models/weapons/v_superphyscannon.mdl"
SWEP.WorldModel			= "models/weapons/v_bugbait.mdl"
...
if (SERVER) then
	...
	flame:SetKeyValue("Damage",6)
	flame:SetKeyValue("DamageDelay",0.38)
...
timer.Simple(3.00, function() if self:IsValid() then self:ReloadSelf() end end)
