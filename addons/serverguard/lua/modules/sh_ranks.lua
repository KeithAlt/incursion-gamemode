...
if (SERVER) then
	...
	serverguard.netstream.Hook("sgRequestPlayerRanks", function(player, data)
		local queryObj = serverguard.mysql:Select("serverguard_users");
			...
			queryObj:WhereNotEqual("rank", "user");
			queryObj:WhereNotEqual("rank", "bronze");
			queryObj:WhereNotEqual("rank", "silver");
			queryObj:WhereNotEqual("rank", "gold");
			queryObj:WhereNotEqual("rank", "diamond");
			queryObj:WhereNotEqual("rank", "legendary");
			queryObj:WhereNotEqual("rank", "bot");
