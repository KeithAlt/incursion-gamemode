...
-- Changed static bools to what they should always be
local config = serverguard.config.Create("propprotection");
	...
	config:AddBoolean("propblacklist", true, "Prop blacklist");
	config:AddBoolean("propspam", true, "Prop spam protection");
	config:AddBoolean("autodelete", true, "Auto-delete disconnected players' props");
