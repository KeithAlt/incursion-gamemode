...
nut.anim.citizen_male = {
	...
	glide = ACT_GLIDE,
	vehicle = {
		["prop_vehicle_prisoner_pod"] = {"podpose", Vector(-3, 0, 55555)},
		["prop_vehicle_jeep"] = {"drinker_sit", Vector(555, 555, 55555)},
		["prop_vehicle_airboat"] = {"drinker_sit", Vector(555, 555, 555555)},
		chair = {ACT_BUSY_SIT_CHAIR_ENTRY, Vector(1, 0, -23)}
	},
}
...
nut.anim.metrocop = {
	...
	glide = ACT_GLIDE,
	vehicle = {
		chair = {ACT_BUSY_SIT_CHAIR, Vector(5, 0, -5)},
		["prop_vehicle_airboat"] = {ACT_BUSY_SIT_CHAIR, Vector(0, 0, 0)},
		["prop_vehicle_jeep"] = {ACT_BUSY_SIT_CHAIR, Vector(18, 0, 4)},
		["prop_vehicle_prisoner_pod"] = {ACT_IDLE, Vector(-4, 0, 0)}
	}
}
nut.anim.overwatch = {
	normal = {
