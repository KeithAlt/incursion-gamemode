...
PLUGIN.itemTable = {
	category 		=	{"rubyeye", "sapphireflower", "rarestone", "ivorysparkler"},
	category2		=	{"greenherb", "rubyfireball", "saphhiresnowflake", "rubyfireball", "rubycompass", "unrefinedgoldfish", "ivorywrenched", "shell", "spinal"},
	category3		=	{"rubycrystal", "goldfish", "spray"},
	category4		=	{"rubyflame", "saphhiresoul", "emeraldgoldfish", "lionsheart"},
}
