...
hook.Add("KeyPress", "nut.playerInteract", function(client, key) -- UI option to zip tie
...
hook.Add("HUDPaint", "nut.playerInteract", function()
    ...
    for _, funcData in SortedPairs(nut.playerInteract.funcs) do
        ...
        draw.SimpleText(name, "nutMediumLightFont", barX + (barW / 2) + 2, barY + (barH / 2.1) + 2, Color(0, 0, 0, interfaceScale * 128), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        draw.SimpleText(name, "nutMediumLightFont", barX + (barW / 2), barY + (barH / 2.1), Color(255, 255, 255, interfaceScale * 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
